...
class ModelPagestockToHszg(QWidget):

    model_id = 'stock_to_hszg'
    model_name = '股票所属行业概念推导模型'
    model_description = '根据股票所在概念、行业、指数去推导走向'

    def __init__(self, parent=None):
        super(ModelPagestockToHszg, self).__init__(parent)
